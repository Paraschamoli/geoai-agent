...
async def test_handler_returns_response():
    ...
    with (
        patch("geoai_agent.main._initialized", True),
...
async def test_handler_initialization():
    ...
    with (
        patch("geoai_agent.main._initialized", False),
        patch("geoai_agent.main.initialize_agent", new_callable=AsyncMock) as _mock_init,
        patch("geoai_agent.main.run_agent", new_callable=AsyncMock, return_value=mock_response),
